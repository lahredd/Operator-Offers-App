...
public class Actv11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent toyy = new Intent(Actv11.this, Actv1.class);
                startActivity(toyy); }});
    ...
    private void refreshAd2() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(Actv11.this, "Failed to load native ad: "
    ...
    private void addMenuItemsFromJson() {
        try {
            ...
            Log.e(Actv11.class.getName(), "Unable to parse JSON file.", exception);
        }
    ...
    private String readJsonDataFromFile() throws IOException {
        ...
        try {
            ...
            inputStream = getResources().openRawResource(R.raw.call_offers);
