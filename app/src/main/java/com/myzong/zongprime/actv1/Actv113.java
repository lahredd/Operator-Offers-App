...
public class Actv113 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a_title.setText("Internet Offers");
        ImageButton button3 =  findViewById(R.id.imageView53);

        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toyy = new Intent(Actv113.this, Actv1.class);
                startActivity(toyy); }});
    ...
    private void refreshAd2() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(Actv113.this, "Failed to load native ad: "
    ...
    private void addMenuItemsFromJson() {
        try {
            ...
            Log.e(Actv113.class.getName(), "Unable to parse JSON file.", exception);
        }
    ...
    private String readJsonDataFromFile() throws IOException {
        ...
        try {
            ...
            inputStream = getResources().openRawResource(R.raw.internet_offers);
