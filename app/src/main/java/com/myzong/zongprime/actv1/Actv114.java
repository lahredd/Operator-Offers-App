...
public class Actv114 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a_title.setText("Device Only Offers");
        ImageButton button3 =  findViewById(R.id.imageView53);

        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toyy = new Intent(Actv114.this, Actv1.class);
                startActivity(toyy); }});
    ...
    private void refreshAd2() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(Actv114.this, "Failed to load native ad: "
    ...
    private void addMenuItemsFromJson() {
        try {
            ...
            Log.e(Actv114.class.getName(), "Unable to parse JSON file.", exception);
        }
    ...
    private String readJsonDataFromFile() throws IOException {
        ...
        try {
            ...
            inputStream = getResources().openRawResource(R.raw.device_offers);
